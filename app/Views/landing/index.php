...
<section id="contact" class="fullpage-section">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <form id="contactForm" class="contact-form" action="https://formsubmit.co/ariasfedericoadrian@gmail.com" method="POST">
...
¡Gracias por confiar en RackON!`;
    ...
    async function sendEmailConfirmation(formData) {
        return await fetch('https://formsubmit.co/ajax/ariasfedericoadrian@gmail.com', {
            method: 'POST',
            body: formData,
            headers: { 
                'Accept': 'application/json',
