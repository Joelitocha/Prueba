  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content p-3">
      ...
      <div class="modal-body text-center">
        ...
        <button id="btnFinalizarCompra" class="btn btn-success mt-4" style="display: none;">Finalizar</button>
      </div>
    </div>
  </div>
</div>
...
<section id="planes" class="fullpage-section">
  <div class="container">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const paypalButtonMensualDiv = document.getElementById('paypal-button-modal-mensual');
        const paypalButtonAnualDiv = document.getElementById('paypal-button-modal-anual');
        ...
        modalCompra.addEventListener('show.bs.modal', function (event) {
          ...
          // Reset visibility for new modal opening
          paypalButtonMensualDiv.style.display = 'block';
          paypalButtonAnualDiv.style.display = 'block';
          btnFinalizarCompra.style.display = 'none'; // Ensure Finalizar button is hidden

          // Limpiar contenedores PayPal antes de renderizar
          paypalButtonMensualDiv.innerHTML = '';
          paypalButtonAnualDiv.innerHTML = '';
          ...
          paypal.Buttons({
            ...
            onApprove: (data, actions) => {
              return actions.order.capture().then(function(details) {
                ...
                // Ocultar botones de PayPal y mostrar botón Finalizar
                paypalButtonMensualDiv.style.display = 'none';
                paypalButtonAnualDiv.style.display = 'none'; 
        ...
        btnFinalizarCompra.addEventListener('click', () => {
            const modal = bootstrap.Modal.getInstance(modalCompra); // Obtener la instancia del modal de Bootstrap
            if (modal) {
