    ...
    <div class="content">
      <div class="crear-container">
        ...
        <form class="crear-form" action="<?php echo site_url('/crear-tarjeta') ?>" method="post">
          ...
          <a href="<?php echo site_url('/modificar-tarjeta');?>" class="btn-back">Volver a Gestión de Tarjetas</a>
        </form>
      </div>
    </div>
