  ...
  <body>
    ...
    <div class="content">
      <div class="form-container">
        <h1>Modificar Usuario <?= esc($usuario['ID_Usuario']); ?></h1>
        <form action="<?= site_url('actualizar-usuario') ?>" method="post">
          ...
          <div class="form-group">
            ...
            <select name="rol" id="rol" required>
              <option value="5" <?= $usuario['ID_Rol'] == 5 ? 'selected' : '' ?>>Administrador</option>
              <option value="6" <?= $usuario['ID_Rol'] == 6 ? 'selected' : '' ?>>Supervisor</option>
              <option value="7" <?= $usuario['ID_Rol'] == 7 ? 'selected' : '' ?>>Usuario</option>
            </select>
          </div>
          ...
          <a href="<?= site_url('modificar-usuario') ?>" class="btn-volver">Volver</a>
        </form>
      </div>
    </div>
